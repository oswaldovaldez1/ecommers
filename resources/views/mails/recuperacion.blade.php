...
<html lang="es">
  <head>
    ...
    <style type="text/css">
      ...
      .bg-rosa {
        background-color: #ef7968 !important;
      }
  ...
  >
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <!-- LOGO -->
      <tr>
        <td bgcolor="#ef7968" align="center">
          <table
            border="0"
            cellpadding="0"
            cellspacing="0"
          ...
          >
            <tr>
              <td
                ...
                "
              >
                <h3 style="font-size: 48px; font-weight: 400; margin: 2;">
            ...
            <tr>
              ...
              >
                <p style="margin: 0; font-size: 18px;">
                  ...
                  Para Actualizar su contraseña de click en el boton de abajo
                </p>
              </td>
            </tr>
            <tr>
                    ...
                    >
                      <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          >
                            <a
                              href="{{url('/recuperacion/'.$datos->token)}}"
                              target="_blank"
                              style="
                                font-size: 20px;

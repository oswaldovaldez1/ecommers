<template>
    ...
    >
        <div class="upload-control" v-show="images.length">
            <label for="file">Seleccione sus archivos</label>
            <button @click="upload">Subir</button>
        </div>

        <div v-show="!images.length">
            <i class="fa fa-cloud-upload"></i>
            <p>Arrastre sus imagenes aquí</p>
            <div>ó</div>
            <div class="file-input">
                <label for="file">Seleccione aquí</label>
        ...
        <div class="images-preview" v-show="images.length">
            <div
                ...
                :key="index"
            >
                <div v-on:click="removeImage(index)" class="quitar ">
                    x
                </div>
...
export default {
    ...
    methods: {
        ...
        upload() {
            ...
            this.axios
                .post("/api/product/upimg", formData, {
                    headers: {
